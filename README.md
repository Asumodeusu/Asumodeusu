...
До IT работал в нефтегазовой сфере: управлял проектами, анализировал данные, координировал команды. Начал с Python для расчётов геомеханических моделей — это подтолкнуло к переходу во фронтенд-разработку. Теперь создаю интерфейсы, которыми пользуются люди.
