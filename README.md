👋 Приветствую всех! Меня зовут Илья — Frontend-разработчик с инженерным бэкграундом.
...
Frontend-разработчик с опытом более года. Разрабатываю приложения на React и TypeScript — проекты с открытым кодом и демо. Работаю с Redux Toolkit, REST API, адаптивной версткой.
